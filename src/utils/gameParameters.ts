...
export const characterArrayLength = 384
export const numWords = 12
export const chunkLength = Math.floor(characterArrayLength / numWords);
...
export const symbolsPerLine = characterArrayLength/(numCols*numLines)